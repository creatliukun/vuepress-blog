...
<h1 id="vuepress搭建博客文档" tabindex="-1"><a class="header-anchor" href="#vuepress搭建博客文档"><span>vuepress搭建博客文档</span></a></h1>
<h1 id="_1-安装nodejs" tabindex="-1"><a class="header-anchor" href="#_1-安装nodejs"><span>1.安装nodejs</span></a></h1>
<p>Node.js v18.19.0+
包管理器，如 pnpm、yarn、npm 等。</p>
<h2 id="手动创建" tabindex="-1"><a class="header-anchor" href="#手动创建"><span>手动创建</span></a></h2>
<ul>
<li>.1创建并进入一个新目录</li>
</ul>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">mkdir</span> vuepress-starter</span>
...
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token comment"># 安装 vuepress</span></span>
...
<li>4.创建 docs 目录和 docs/.vuepress 目录</li>
</ul>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">mkdir</span> docs</span>
<span class="line"><span class="token function">mkdir</span> docs/.vuepress</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>5.创建 VuePress 配置文件 docs/.vuepress/config.js</li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> viteBundler <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'@vuepress/bundler-vite'</span></span>
...
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token builtin class-name">echo</span> <span class="token string">'# Hello VuePress'</span> <span class="token operator">></span> docs/README.md</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h2 id="目录结构" tabindex="-1"><a class="header-anchor" href="#目录结构"><span>目录结构</span></a></h2>
<ul>
<li>创建完成后，你项目的目录结构应该是这样的：</li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">├─ docs</span>
...
<ul>
<li>示例 .gitignore 文件</li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line"># VuePress 默认临时文件目录</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="开始使用-vuepress" tabindex="-1"><a class="header-anchor" href="#开始使用-vuepress"><span>开始使用 VuePress</span></a></h2>
<ul>
<li>启动开发服务器
你可以在 package.json 中添加一些 scripts ：</li>
</ul>
...
<li>运行 docs:dev 脚本可以启动开发服务器:</li>
<li>VuePress 会在 http://localhost:8080 启动一个热重载的开发服务器。当你修改你的 Markdown 文件时，浏览器中的内容也会自动更新。</li>
</ul>
<h2 id="自动化构建" tabindex="-1"><a class="header-anchor" href="#自动化构建"><span>自动化构建</span></a></h2>
<ul>
<li>在项目根目录，新增一个.github/workflows/deploy-docs.yml 文件;里面的配置如下</li>
</ul>
<div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre v-pre><code><span class="line"></span>
...
<ul>
<li>注意点1：当推送到main分支时，会自动化部署。这个时候等待一段时间即可；</li>
<li>注意点2: GitHub Pages 设置；GitHub Pages 是 GitHub 提供的静态网站托管服务。你需要在仓库设置中启用它。</li>
</ul>
<p>操作步骤：</p>
<div class="language-docs line-numbers-mode" data-highlighter="prismjs" data-ext="docs"><pre v-pre><code><span class="line">登录到 GitHub 并进入你的仓库。</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在刷新一下，就能看到部署后的网站了</p>
<ul>
<li>注意点3: 样式丢失问题：
base 配置错误</li>
</ul>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line">VuePress 的 base 配置决定了生成的静态文件中资源路径的前缀。</span>
